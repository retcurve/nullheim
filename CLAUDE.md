...
gets stored. The model needs a one-time per-account opt-in call before use, and
its license withholds the multimodal grant from accounts domiciled in the EU —
check this before deploying to one.
